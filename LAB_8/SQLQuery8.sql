...
SELECT YEAR,REGION,MIN(SALES_AMOUNT) AS MINSALES 
FROM SALES_DATA
GROUP BY REGION,YEAR

--5. Count of Products Sold by Region

SELECT REGION,COUNT(PRODUCT) AS TOTAL_SALES 
FROM SALES_DATA
GROUP BY REGION
...
SELECT SUM(SALES_AMOUNT) AS TOTALAMOUNT,REGION 
FROM SALES_DATA
WHERE YEAR='2023'
GROUP BY REGION
...
SELECT COUNT(SALES_AMOUNT),YEAR,REGION 
FROM SALES_DATA
...
SELECT AVG(SALES_AMOUNT) AS AVG_SAL, PRODUCT 
FROM SALES_DATA
GROUP BY PRODUCT
...
SELECT PRODUCT,REGION,COUNT(PRODUCT)
FROM SALES_DATA
